...
- 세션당 최대 24개 도구·3분, 동작별 live package/window/revision 재검증, 사용자 중단 즉시 취소
...
성공 경로는 화면 상태 순환을 지운 뒤 앱 열기·노드 클릭·좌표 클릭·입력·스크롤별 비용을 합산합니다. 같은 시작 문맥의 기존 경로보다 짧을 때만 교체하며 최대 80개·90일을 보관합니다. 입력값·원본 명령·스크린샷·화면 본문은 저장하지 않습니다.
