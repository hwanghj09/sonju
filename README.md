...
명령 음성은 기기의 Android 기기 내 인식기를 우선 사용하고, 한국어 모델을 사용할 수 없으면 듣기 시작 전에 기본 음성 인식기로 전환합니다. 홈과 음성 패널 모두 같은 설정과 설치 앱 이름 힌트를 사용하며, 지원하는 엔진에서는 인식기를 재시작하지 않고 문장을 받습니다. 중간 자막은 최종 결과로 수정될 수 있습니다. OpenAI 등 유료 음성 전사 API는 사용하지 않습니다. 수정 근거와 검증 범위는 [음성 인식 검증 기록](docs/SPEECH_RECOGNITION_RELIABILITY.md)에 있습니다.
